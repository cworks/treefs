 ...
 * MainVerticle boots
 * 1) TreeFsServer
 * 2) Misc verticles specified in treefsconfig.json
 *
 * @author corbett
 */
public class MainVerticle extends Verticle {
    ...
    void deployStandardVerticle(String clazzName, JsonObject config, Integer instances,
        ...
        logger.info(String.format("deployed Verticle: %s instances: %d config: %s",
            clazzName, instances, config.encode()));
    }
    ...
    void deployWorkerVerticle(String clazzName, JsonObject config, Integer instances,
        ...
        logger.info(String.format("deployed Worker Verticle: %s instances: %d config: %s",
            clazzName, instances, config.encode()));
    }
