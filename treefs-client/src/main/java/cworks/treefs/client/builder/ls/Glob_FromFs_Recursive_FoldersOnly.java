...
public interface Glob_FromFs_Recursive_FoldersOnly<_ReturnType> {

    @MethodMeta(type = TransitionType.Recursive)
    Glob_FromFs_Recursive_FoldersOnly<_ReturnType> glob(String pattern);

    @MethodMeta(type = TransitionType.Lateral)
    Glob_Recursive_FoldersOnly<_ReturnType> fromFs(String fs);

    @MethodMeta(type = TransitionType.Lateral)
    Glob_FromFs_FoldersOnly<_ReturnType> recursive();

    @MethodMeta(type = TransitionType.Lateral)
    Glob_FromFs_Recursive<_ReturnType> foldersOnly();
